...
(function () {
  ...
  const LOCALES = {
    es: {
      ...
      tools: { section_title:"Herramientas del Hub", vault_desc:"Gestiona y organiza modelos. Integración con Civitai.", merger_desc:"Combina LoRAs con métodos avanzados: slerp, TIES, DARE.", open:"Abrir", launched:"Herramienta iniciada.", launch_error:"No se pudo iniciar.", error:"Error al lanzar la herramienta." },
      settings: {
    ...
    en: {
      ...
      tools: { section_title:"Hub Tools", vault_desc:"Manage and organize models. Civitai integration.", merger_desc:"Combine LoRAs with advanced methods: slerp, TIES, DARE.", open:"Open", launched:"Tool launched.", launch_error:"Could not launch.", error:"Error launching tool." },
      settings: {
