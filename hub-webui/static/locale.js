  ...
  const LOCALES = {
    es: {
      ...
      settings: {
        ...
        purge_placeholder:"paquete concreto, ej. torch (vacío = cache completo)",
        purge_btn:"🗑 Purgar", purging:"Purgando...",
    ...
    en: {
      ...
      settings: {
        ...
        purge_placeholder:"specific package, e.g. torch (empty = entire cache)",
        purge_btn:"🗑 Purge", purging:"Purging...",
