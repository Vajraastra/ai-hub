  ...
  const LOCALES = {
    es: {
      ...
      painter: {
        ...
        btn_select_all:"Seleccionar todo (Ctrl+A)", btn_invert_mask:"Invertir máscara (I)",
        tab_generate:"Generar", tab_outpaint:"Outpaint", tab_upscale:"Upscale", tab_controlnet:"ControlNet",
        ptab_model:"Modelo", ptab_sampling:"Muestreo", ptab_mods:"Mods",
        pb_collapse:"▾ Plegar", pb_collapse_tip:"Plegar la barra de prompt",
        pb_expand_tip:"Desplegar la barra de prompt",
        pb_no_prompt:"Sin prompt — clic para escribir",
        ...
        op_note:"Usa el prompt de la barra inferior y el checkpoint de la pestaña Modelo.",
    ...
    en: {
      ...
      painter: {
        ...
        btn_select_all:"Select all (Ctrl+A)", btn_invert_mask:"Invert mask (I)",
        tab_generate:"Generate", tab_outpaint:"Outpaint", tab_upscale:"Upscale", tab_controlnet:"ControlNet",
        ptab_model:"Model", ptab_sampling:"Sampling", ptab_mods:"Mods",
        pb_collapse:"▾ Collapse", pb_collapse_tip:"Collapse the prompt bar",
        pb_expand_tip:"Expand the prompt bar",
        pb_no_prompt:"No prompt — click to write",
        ...
        op_note:"Uses the prompt from the bottom bar and the checkpoint from the Model tab.",
