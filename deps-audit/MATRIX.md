...
Apps con datos (7): ai-toolkit, anima-standalone-trainer, comfyui, dataset-refiner, facefusion, sd-webui-forge-neo, taggui
Total deps distintas: 262 · cruzadas (≥2 apps): **133** · únicas: 129 · cruzadas con conflicto de versión: **48**

#### Cruzadas (candidatas a pool compartido)
| Dependencia | #apps | Versiones por app | ¿Conflicto? |
|---|---|---|---|
| `certifi` | 7 | ai-toolkit=2026.6.17, anima-standalone-trainer=2026.6.17, comfyui=2026.6.17, dataset-refiner=2026.6.17, facefusion=2026.6.17, sd-webui-forge-neo=2026.6.17, taggui=2026.6.17 | ok |
| `charset-normalizer` | 7 | ai-toolkit=3.4.7, anima-standalone-trainer=3.4.7, comfyui=3.4.7, dataset-refiner=3.4.7, facefusion=3.4.7, sd-webui-forge-neo=3.4.7, taggui=3.4.7 | ok |
| `colorama` | 7 | ai-toolkit=0.4.6, anima-standalone-trainer=0.4.6, comfyui=0.4.6, dataset-refiner=0.4.6, facefusion=0.4.6, sd-webui-forge-neo=0.4.6, taggui=0.4.6 | ok |
| `filelock` | 7 | ai-toolkit=3.29.0, anima-standalone-trainer=3.29.0, comfyui=3.29.0, dataset-refiner=3.29.4, facefusion=3.29.4, sd-webui-forge-neo=3.29.0, taggui=3.29.0 | ⚠️ SÍ |
| `fsspec` | 7 | ai-toolkit=2026.4.0, anima-standalone-trainer=2026.4.0, comfyui=2026.4.0, dataset-refiner=2026.6.0, facefusion=2026.6.0, sd-webui-forge-neo=2026.4.0, taggui=2026.4.0 | ⚠️ SÍ |
| `huggingface-hub` | 7 | ai-toolkit=1.10.1, anima-standalone-trainer=0.34.3, comfyui=1.21.0, dataset-refiner=1.21.0, facefusion=0.36.2, sd-webui-forge-neo=0.36.2, taggui=0.35.3 | ⚠️ SÍ |
| `idna` | 7 | ai-toolkit=3.18, anima-standalone-trainer=3.18, comfyui=3.18, dataset-refiner=3.18, facefusion=3.18, sd-webui-forge-neo=3.18, taggui=3.18 | ok |
| `jinja2` | 7 | ai-toolkit=3.1.6, anima-standalone-trainer=3.1.6, comfyui=3.1.6, dataset-refiner=3.1.6, facefusion=3.1.6, sd-webui-forge-neo=3.1.6, taggui=3.1.6 | ok |
| `markupsafe` | 7 | ai-toolkit=3.0.3, anima-standalone-trainer=3.0.3, comfyui=3.0.3, dataset-refiner=3.0.3, facefusion=3.0.3, sd-webui-forge-neo=2.1.5, taggui=3.0.3 | ⚠️ SÍ |
| `numpy` | 7 | ai-toolkit=2.4.4, anima-standalone-trainer=2.4.4, comfyui=2.4.4, dataset-refiner=2.5.0, facefusion=2.2.1, sd-webui-forge-neo=2.3.5, taggui=2.4.4 | ⚠️ SÍ |
| `packaging` | 7 | ai-toolkit=26.2, anima-standalone-trainer=26.2, comfyui=26.2, dataset-refiner=26.2, facefusion=26.2, sd-webui-forge-neo=26.0, taggui=26.2 | ⚠️ SÍ |
| `pillow` | 7 | ai-toolkit=11.3.0, anima-standalone-trainer=12.2.0, comfyui=12.2.0, dataset-refiner=12.2.0, facefusion=11.3.0, sd-webui-forge-neo=12.2.0, taggui=11.3.0 | ⚠️ SÍ |
| `pyyaml` | 7 | ai-toolkit=6.0.3, anima-standalone-trainer=6.0.3, comfyui=6.0.3, dataset-refiner=6.0.3, facefusion=6.0.3, sd-webui-forge-neo=6.0.3, taggui=6.0.3 | ok |
| `requests` | 7 | ai-toolkit=2.34.2, anima-standalone-trainer=2.34.2, comfyui=2.34.2, dataset-refiner=2.34.2, facefusion=2.34.2, sd-webui-forge-neo=2.34.2, taggui=2.34.2 | ok |
| `tqdm` | 7 | ai-toolkit=4.68.3, anima-standalone-trainer=4.68.3, comfyui=4.68.3, dataset-refiner=4.68.3, facefusion=4.67.3, sd-webui-forge-neo=4.67.3, taggui=4.68.3 | ⚠️ SÍ |
| `typing-extensions` | 7 | ai-toolkit=4.15.0, anima-standalone-trainer=4.15.0, comfyui=4.15.0, dataset-refiner=4.15.0, facefusion=4.15.0, sd-webui-forge-neo=4.15.0, taggui=4.15.0 | ok |
| `urllib3` | 7 | ai-toolkit=2.7.0, anima-standalone-trainer=2.7.0, comfyui=2.7.0, dataset-refiner=2.7.0, facefusion=2.7.0, sd-webui-forge-neo=2.7.0, taggui=2.7.0 | ok |
...
| `mpmath` | 5 | ai-toolkit=1.3.0, anima-standalone-trainer=1.3.0, comfyui=1.3.0, sd-webui-forge-neo=1.3.0, taggui=1.3.0 | ok |
| `networkx` | 5 | ai-toolkit=3.6.1, anima-standalone-trainer=3.6.1, comfyui=3.6.1, sd-webui-forge-neo=3.6.1, taggui=3.6.1 | ok |
| `protobuf` | 5 | ai-toolkit=7.35.1, anima-standalone-trainer=7.35.1, facefusion=7.35.1, sd-webui-forge-neo=4.25.9, taggui=7.35.1 | ⚠️ SÍ |
| `psutil` | 5 | ai-toolkit=7.2.2, anima-standalone-trainer=7.2.2, comfyui=7.2.2, sd-webui-forge-neo=6.1.1, taggui=7.2.2 | ⚠️ SÍ |
| `regex` | 5 | ai-toolkit=2026.5.9, anima-standalone-trainer=2026.5.9, comfyui=2026.5.9, sd-webui-forge-neo=2026.5.9, taggui=2026.5.9 | ok |
| `safetensors` | 5 | ai-toolkit=0.8.0, anima-standalone-trainer=0.4.5, comfyui=0.8.0, sd-webui-forge-neo=0.7.0, taggui=0.8.0 | ⚠️ SÍ |
| `scipy` | 5 | ai-toolkit=1.18.0, comfyui=1.18.0, dataset-refiner=1.18.0, facefusion=1.17.0, sd-webui-forge-neo=1.18.0 | ⚠️ SÍ |
| `setuptools` | 5 | ai-toolkit=69.5.1, anima-standalone-trainer=80.0.0, comfyui=70.2.0, sd-webui-forge-neo=69.5.1, taggui=70.2.0 | ⚠️ SÍ |
| `shellingham` | 5 | ai-toolkit=1.5.4, comfyui=1.5.4, dataset-refiner=1.5.4, facefusion=1.5.4, sd-webui-forge-neo=1.5.4 | ok |
| `sympy` | 5 | ai-toolkit=1.14.0, anima-standalone-trainer=1.14.0, comfyui=1.14.0, sd-webui-forge-neo=1.14.0, taggui=1.14.0 | ok |
| `tokenizers` | 5 | ai-toolkit=0.22.2, anima-standalone-trainer=0.21.4, comfyui=0.22.2, sd-webui-forge-neo=0.22.2, taggui=0.21.4 | ⚠️ SÍ |
| `torch` | 5 | ai-toolkit=2.10.0+cu130, anima-standalone-trainer=2.10.0+cu130, comfyui=2.10.0+cu130, sd-webui-forge-neo=2.10.0+cu130, taggui=2.10.0+cu130 | ok |
| `torchaudio` | 5 | ai-toolkit=2.10.0+cu130, anima-standalone-trainer=2.11.0+cu130, comfyui=2.10.0+cu130, sd-webui-forge-neo=2.10.0+cu130, taggui=2.10.0+cu130 | ⚠️ SÍ |
| `torchvision` | 5 | ai-toolkit=0.25.0+cu130, anima-standalone-trainer=0.25.0+cu130, comfyui=0.25.0+cu130, sd-webui-forge-neo=0.25.0+cu130, taggui=0.25.0+cu130 | ok |
| `transformers` | 5 | ai-toolkit=5.5.3, anima-standalone-trainer=4.54.1, comfyui=5.12.1, sd-webui-forge-neo=4.56.2, taggui=4.48.3 | ⚠️ SÍ |
| `typer` | 5 | ai-toolkit=0.26.8, comfyui=0.25.1, dataset-refiner=0.25.1, facefusion=0.26.8, sd-webui-forge-neo=0.25.1 | ⚠️ SÍ |
| `accelerate` | 4 | ai-toolkit=1.14.0, anima-standalone-trainer=1.6.0, sd-webui-forge-neo=1.13.0, taggui=1.10.1 | ⚠️ SÍ |
...
| `bitsandbytes` | 3 | ai-toolkit=0.49.2, anima-standalone-trainer=0.49.2, taggui=0.48.1 | ⚠️ SÍ |
...
#### Únicas (129)
`addict`(sd-webui-forge-neo), `aiohappyeyeballs`(comfyui), `aiohttp`(comfyui), `aiosignal`(comfyui), `albucore`(ai-toolkit), `albumentations`(ai-toolkit), `alembic`(comfyui), `audioread`(ai-toolkit), `beautifulsoup4`(dataset-refiner), `blake3`(comfyui), `blinker`(anima-standalone-trainer), `clean-fid`(ai-toolkit), `clip-anytorch`(ai-toolkit), `coloredlogs`(taggui), `comfy-aimdo`(comfyui), `comfyui-embedded-docs`(comfyui), `comfyui-frontend-package`(comfyui), `comfyui-workflow-templates`(comfyui), `comfyui-workflow-templates-core`(comfyui), `comfyui-workflow-templates-media-api`(comfyui), `comfyui-workflow-templates-media-image`(comfyui), `comfyui-workflow-templates-media-other`(comfyui), `comfyui-workflow-templates-media-video`(comfyui), `controlnet-aux`(ai-toolkit), `cssselect2`(sd-webui-forge-neo), `cuda-direct-backend`(anima-standalone-trainer), `dctorch`(ai-toolkit), `decorator`(ai-toolkit), `deep-translator`(dataset-refiner), `depth-anything`(sd-webui-forge-neo), `depth-anything-v2`(sd-webui-forge-neo), `diskcache`(sd-webui-forge-neo), `eval-type-backport`(ai-toolkit), `exifread`(taggui), `facexlib`(sd-webui-forge-neo), `filterpy`(sd-webui-forge-neo), `flask`(anima-standalone-trainer), `flatten-json`(ai-toolkit), `frozenlist`(comfyui), `fvcore`(sd-webui-forge-neo), `glfw`(comfyui), `greenlet`(comfyui), `hf-gradio`(dataset-refiner), `hf-transfer`(ai-toolkit), `humanfriendly`(taggui), `imagehash`(dataset-refiner), `importlib-resources`(sd-webui-forge-neo), `inflection`(sd-webui-forge-neo), `insightface`(sd-webui-forge-neo), `invisible-watermark`(ai-toolkit), `iopath`(sd-webui-forge-neo), `itsdangerous`(anima-standalone-trainer), `jsonmerge`(ai-toolkit), `jsonschema`(ai-toolkit), `jsonschema-specifications`(ai-toolkit), `k-diffusion`(ai-toolkit), `lark`(sd-webui-forge-neo), `librosa`(ai-toolkit), `lion-pytorch`(anima-standalone-trainer), `lpips`(ai-toolkit), `lxml`(sd-webui-forge-neo), `lycoris-lora`(ai-toolkit), `mako`(comfyui), `mediapipe`(sd-webui-forge-neo), `msgpack`(ai-toolkit), `multidict`(comfyui), `mutagen`(ai-toolkit), `ninja`(ai-toolkit), `nvidia-ml-py`(sd-webui-forge-neo), `onnxruntime-gpu`(facefusion), `open-clip-torch`(ai-toolkit), `opencv-contrib-python`(sd-webui-forge-neo), `optimum-quanto`(ai-toolkit), `oyaml`(ai-toolkit), `piexif`(sd-webui-forge-neo), `pillow-heif`(sd-webui-forge-neo), `pillow-jxl-plugin`(sd-webui-forge-neo), `plotly`(dataset-refiner), `polars`(sd-webui-forge-neo), `polars-runtime-32`(sd-webui-forge-neo), `pooch`(ai-toolkit), `portalocker`(sd-webui-forge-neo), `prodigy-plus-schedule-free`(anima-standalone-trainer), `propcache`(comfyui), `pydantic-settings`(comfyui), `pyopengl`(comfyui), `pyreadline3`(taggui), `pyside6`(taggui), `pyside6-addons`(taggui), `pyside6-essentials`(taggui), `python-slugify`(ai-toolkit), `pytorch-fid`(ai-toolkit), `pytorch-optimizer`(anima-standalone-trainer), `pytorch-wavelets`(ai-toolkit), `pywin32`(sd-webui-forge-neo), `referencing`(ai-toolkit), `reportlab`(sd-webui-forge-neo), `rpds-py`(ai-toolkit), `schedulefree`(anima-standalone-trainer), `scikit-learn`(ai-toolkit), `shiboken6`(taggui), `simpleeval`(comfyui), `sniffio`(sd-webui-forge-neo), `sounddevice`(sd-webui-forge-neo), `soundfile`(ai-toolkit), `soupsieve`(dataset-refiner), `soxr`(ai-toolkit), `spandrel-extra-arches`(sd-webui-forge-neo), `sqlalchemy`(comfyui), `standard-aifc`(ai-toolkit), `standard-chunk`(ai-toolkit), `standard-sunau`(ai-toolkit), `svglib`(sd-webui-forge-neo), `tabulate`(sd-webui-forge-neo), `termcolor`(sd-webui-forge-neo), `text-unidecode`(ai-toolkit), `threadpoolctl`(ai-toolkit), `tinycss2`(sd-webui-forge-neo), `tomesd`(sd-webui-forge-neo), `torchao`(ai-toolkit), `torchcodec`(ai-toolkit), `ultralytics`(sd-webui-forge-neo), `ultralytics-thop`(sd-webui-forge-neo), `voluptuous`(anima-standalone-trainer), `wd-parallel`(anima-standalone-trainer), `webencodings`(sd-webui-forge-neo), `yacs`(sd-webui-forge-neo), `yapf`(sd-webui-forge-neo), `yarl`(comfyui)
