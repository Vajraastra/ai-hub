...
Reporte: resumen por stdout + JSON detallado en
  apps/forge_fusion/data/alias_battery_report.json
"""
import argparse
import hashlib
import json
...
from forge_fusion.core import lora_alias  # noqa: E402
from forge_fusion.core.architectures import get_adapter  # noqa: E402
from forge_fusion.core.lora_format import LoraFormatError, collect_pairs  # noqa: E402
...
async def level3(models_root: Path, converted: list[dict], sample: int,
    ...
    from forge_fusion.core.architectures.sdxl import _CONV_GROUPS
    key_map = adapter.lora_key_map()
